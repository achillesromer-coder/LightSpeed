...
## Purpose
Coordinate bounded cross-floor work, priority, model assignment, and duplicate suppression.

## Authority
- This folder is the approved long-term exchange persistence target for Neo.
