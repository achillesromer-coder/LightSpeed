...
## Purpose
Own the single operator interface, interaction contracts, and human review gates.

## Authority
- This folder is the approved long-term floor persistence target for Trinity.
