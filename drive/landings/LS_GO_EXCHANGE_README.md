...
## Purpose
Exchange private mobile dashboard tasks and receipts with Neo through governed references.

## Authority
- This folder is the approved long-term exchange persistence target for LS GO.
- The workbook is a compact index and review surface, not an independent truth store.
- Canonical source: https://github.com/achillesromer-coder/LightSpeed
