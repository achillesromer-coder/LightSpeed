...
## Purpose
Own diagnostics, telemetry, persistence, retention, and maintenance evidence.

## Authority
- This folder is the approved long-term floor persistence target for Merovingian.
