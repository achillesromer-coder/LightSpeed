(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[{name:`Central Facility Boundary`,radiusM:2500,description:`All facilities and buildings remain inside this radius.`},{name:`Active Eco-Restoration`,radiusM:3500,description:`1 km active band for managed biome, native rehabilitation, and functional climate pockets.`},{name:`Passive Eco-Restoration`,radiusM:11e3,description:`Outer passive restoration reserve securing the full radial print.`}],t=[{id:`integration-hall`,name:`Integration Hall`,footprint:`40 m x 75 m, 22 m clear`,elevation:`+1.5 m floor, +8% beveled foundation`,releaseStatus:`canonical`,notes:`Starship-compatible roller doors both ends; single bridge crane spans the hall.`},{id:`chainhill`,name:`ChainHill Relay`,footprint:`~225-250 m relay length`,elevation:`flat raised concrete, approximately 3 m above water table`,releaseStatus:`bounded-assumption`,notes:`Incoming and outgoing tracks oppose each other with two anti-parallel internal lines.`},{id:`x-pads`,name:`X-Layout Pads`,footprint:`solid pads, no beveled building base`,elevation:`pad-specific hardstand`,releaseStatus:`canonical`,notes:`Flame/exhaust outlets orient away from central node and buildings.`},{id:`mission-control`,name:`Mission Control / ATC`,footprint:`pentagon base, level 1 at 80%, four-storey tower`,elevation:`+1.5 m floor, +8% beveled foundation`,releaseStatus:`canonical`,notes:`Foyer, cafeteria, meeting, offices, emergency access, elevator, and top operating floor.`},{id:`living-rd`,name:`R&D + Living Quarters`,footprint:`room-level workbook detail pending`,elevation:`+1.5 m floor, +8% beveled foundation`,releaseStatus:`known-unknown`,notes:`FIFO and FIFO+family support with ground community and rooftop lifestyle zones.`}],n=[`site_zones`,`facilities`,`rooms_spaces`,`roads_tracks`,`pads_exhaust`,`eco_restoration`,`standards_evidence`,`viewer_toggles`,`known_unknowns`],r=document.getElementById(`app`);if(!r)throw Error(`LightSpeed Go mount node #app not found.`);var i=[[`GitHub`,`Authenticated`,`Connected account verified; private identity held in gated handoff`,`pass`],[`Google Drive`,`Authenticated`,`Connected account verified; writeback remains approval-gated`,`pass`],[`Gmail`,`Authenticated`,`Connected account verified; outbound send remains approval-gated`,`pass`]],a=[[`/ls-go`,`HTTP 200`,`Public route is live`,`pass`],[`/ls-go/status`,`HTTP 200`,`Status route is live`,`pass`],[`/ls-go/handoff`,`HTTP 200`,`Handoff route is live`,`pass`],[`/ls-go/review`,`HTTP 200`,`Review route is live`,`pass`],[`/ls-go/agents`,`HTTP 404`,`Agent route is not published yet; keep it out of primary navigation until live`,`warn`]],o=[[`Achilles Core`,`Governance/source-of-truth`,`:00 / :48`,`ready`],[`Co-Runner`,`Drive review and workbook reconciliation`,`:12`,`ready`],[`Desktop Codex`,`Repo build, branch, app evidence`,`:24`,`ready`],[`Terminal Codex`,`Shell validation and command receipts`,`:24`,`ready`],[`Claude/UI`,`Console and agent-lane artifact pass`,`:36`,`ready`],[`Local Runners`,`One-session De Sporte/Ollama gate`,`:48`,`warn`]],s=[[`LightSpeed Go`,`Vite 8 build green`,`C-drive staging is the build lane while D: remains space constrained`,`pass`],[`De Sporte`,`Desktop/runtime world shell`,`Packaged Cognigrex shortcut uses explicit data-root and stays resident`,`ready`],[`Cognigrex`,`Operator shell + Smith queue proof`,`Desktop launch lane is active; capture UI proof after public route update`,`warn`]],c=[[`Short-term`,`RAM/current run only`,`Keep run deltas compact; do not accumulate raw logs in prompt memory`],[`Long-term`,`Drive/repo/local review records`,`Persist evidence paths, hashes, route statuses, and blockers only`],[`Safety`,`No secret persistence`,`Never store credential values, OAuth secrets, wallet/token/payment/custody/IPFS data`]],l=e=>e.map(([e,t,n,r])=>`
    ...
    `).join(``),f=n.map(e=>`<code>${e}</code>`).join(``);r.innerHTML=`
      ...
      <article class="panel wide">
        ...
        <div class="twin-grid">
          ...
          <div class="twin-details">
            <div class="zone-grid">${u}</div>
            <ul class="facility-list">${d}</ul>
            <p class="workbook-link">Workbook-backed embed contract: ${f}</p>
          </div>
        </div>
      </article>
