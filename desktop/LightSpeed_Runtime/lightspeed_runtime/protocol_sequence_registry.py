    ...
    return {
        ...
        "spreadsheet_books": [
            ...
            },
            {
                ...
                "owner_floor": "Neo",
                "role": "materialized LS GO phone dash task queue, approvals, device commands, results, and sync health",
        ...
        "drive_queue_contracts": [
            {
                ...
                "url": "https://drive.google.com/drive/folders/1PkXMyv26BBvvUbxShTRMTwhnEaK_a1qb",
                "owner_floor": "Neo",
                "connector_status": "workbook_materialized",
                "queue_spreadsheet_id": "1f5i4V3FshYHkztv3_HAg0ZofUl0sdcJZcwrlesUlCfM",
                "role": "folder and native workbook bridge for future phone dash task queue and device command bridge",
