...
LS_WEB_GO_ROUTES = [
    ...
    ("/operations/w1", "workspace", "W1 Deposit Workspace", "no prod action"),
    ("/operations/w2", "workspace", "W2 Luke Workspace", "no prod action"),
    ("/operations/w3", "workspace", "W3 RFS / EMFF Workspace", "claim-gated"),
    ("/operations/w4", "workspace", "W4 Supply Chain Workspace", "claim-gated"),
    ("/operations/w5", "workspace", "W5 GMAT Workspace", "simulation only"),
    ("/operations/w6", "workspace", "W6 Asset / Evidence Library", "privacy review"),
    ...
    ("/library", "special", "Library", "route index only"),
...
def build_romer_web_integration(root: Path) -> dict:
    ...
    return {
        ...
        "pre_walkthrough_tasks": [
            ...
            "Verify /ls-go, /ls-go/status, /ls-go/handoff, /ls-go/agents, /ls-go/review, /data/achilles, and /data against 07_Implementation_Log.",
